...
var _owner_character: BaseCharacter = null  # ← ajout
...
func launch(dir: float, dmg: int, owner_char: BaseCharacter = null) -> void:
	_owner_character = owner_char  # ← ajout
	direction = dir
	damage = dmg
